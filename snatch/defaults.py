...
from .constants import VERSION  # Version defined in constants.py
...
from .constants import DEFAULT_TIMEOUT  # Timeout defined in constants.py
...
║                                                                          ║
║  📚 BATCH OPERATIONS:                                                   ║
║    snatch "URL1" "URL2" "URL3"                                            ║
║    snatch "URL1" "URL2" --audio-only --stats                              ║
║                                                                          ║
╚══════════════════════════════════════════════════════════════════════════╝
"""
